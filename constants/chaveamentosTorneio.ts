...
export const FORMATOS_PARTIDA_TORNEIO: FormatoPartidaTorneio[] = [
  ...
  { id: 'melhor_de_3', label: 'Melhor de 3', esportes: 'todos' },
  { id: 'melhor_de_3_stb', label: 'Md3 + Super TB 10', esportes: 'todos' },
  { id: 'melhor_de_5', label: 'Melhor de 5', esportes: ['tenis'] },
  { id: 'melhor_de_5_stb', label: 'Md5 + STB', esportes: ['tenis'] },
